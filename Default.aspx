...
<body id="mybody" runat="server"> 
    ...
    <div id="headerDiv" runat="server" 
        style="margin: 0px 0px 20px 0px; vertical-align: top;
background-color: #666699; height: 50px; 
top: -10px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
color: #66FFFF; font-weight: bold;">
        <h1>Контакты</h1>
   ...
   <asp:Button runat="server" Text="Добавить" id="AddContact" 
       ...
       <div>
           <asp:GridView
               ...
               AllowPaging="True"
               PageSize ="5" Width="100%" MaxHeight="350" OnRowCommand="GridView1_RowCommand"
...
<ControlStyle CssClass="idBound" ForeColor="#336699">

</ControlStyle>

<HeaderStyle CssClass="idBound" ForeColor="#5D7B9D">

</HeaderStyle>

<ItemStyle CssClass="idBound" ForeColor="#F7F6F3">
...
<div id="divPopUp" class="pnlBackGround" >
     ...
     <div id="main" class="main">
        ...
        <asp:RegularExpressionValidator runat="server" 
                                ...
                                Text="не корректный формат номера телефона"
